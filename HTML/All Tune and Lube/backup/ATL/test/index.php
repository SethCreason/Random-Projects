	...
	<body>
		...
		$privatekey = "6Le_Et4SAAAAAMNr7Hg9SEOyGtB4U4wa0KNZln0b";
			...
			if(trim($_POST['checking']) !== '') {
				...
				$authorNumber = (filter_var($_POST['formNumber'], FILTER_SANITIZE_STRING));
				if ($authorNumber == ""){
					$authorError = true;
					$hasError = true;
				}else{
					$formNumber = $authorNumber;
				};
		...
		<?php // if there are errors in the form show a message ?>
			...
			<form id="contactForm" action="" method="post">
				...
				<div id="commentTxt">
					...
					<textarea class="requiredField <?php if($reasonError) { echo 'formError'; } ?>" id="formReason" name="formReason" cols="40" rows="5"><?php if(isset($_POST['formReason'])) { if(function_exists('stripslashes')) { echo stripslashes($_POST['formReason']); } else { echo $_POST['formContent']; } } ?></textarea>
					<?php 
